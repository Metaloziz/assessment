...
> `this`, `event.target` и `event.currentTarget` отвечают на разные вопросы: какой контекст вызова, где родился event и на каком элементе сейчас выполняется обработчик.
