...
> = {
  ...
  // JS (порядок как в Notion Todo List (6) / view JS; уровень = Status)
  ...
  '81-js-declarations-functions': { groupId: 'js', level: 'junior', sortInGroup: 5 },
  ...
  '90-js-class-inheritance': { groupId: 'js', level: 'junior', sortInGroup: 14 },
  '91-js-event-bubbling-capturing': { groupId: 'js', level: 'junior', sortInGroup: 15 },
  '92-js-forms-native': { groupId: 'js', level: 'junior', sortInGroup: 16 },
  '93-js-lexical-environment': { groupId: 'js', level: 'junior', sortInGroup: 17 },
  '94-js-scope-chain': { groupId: 'js', level: 'junior', sortInGroup: 18 },
  '95-js-bind-call-apply': { groupId: 'js', level: 'junior', sortInGroup: 19 },
  '96-js-prototype-chain': { groupId: 'js', level: 'junior', sortInGroup: 20 },
  '97-js-arrow-prototype': { groupId: 'js', level: 'junior', sortInGroup: 21 },
  '98-js-live-collections': { groupId: 'js', level: 'junior', sortInGroup: 22 },
  '99-js-event-delegation': { groupId: 'js', level: 'junior', sortInGroup: 23 },
  '100-js-event-this': { groupId: 'js', level: 'junior', sortInGroup: 24 },
  '101-js-arrow-syntax': { groupId: 'js', level: 'junior', sortInGroup: 25 },
  '102-js-factory-functions': { groupId: 'js', level: 'junior', sortInGroup: 26 },
  '103-js-prototypal-inheritance': { groupId: 'js', level: 'junior', sortInGroup: 27 },
  '104-js-null-prototype': { groupId: 'js', level: 'junior', sortInGroup: 28 },
  '105-js-mutation-observer': { groupId: 'js', level: 'junior', sortInGroup: 29 },
  '106-js-selection-range': { groupId: 'js', level: 'junior', sortInGroup: 30 },
  '107-js-iife': { groupId: 'js', level: 'senior', sortInGroup: 31 },
  '108-js-currying': { groupId: 'js', level: 'senior', sortInGroup: 32 },
  '109-js-private-static-fields': { groupId: 'js', level: 'senior', sortInGroup: 33 },
  '110-js-delegation-pattern': { groupId: 'js', level: 'senior', sortInGroup: 34 },
  '111-js-v8-gc': { groupId: 'js', level: 'senior', sortInGroup: 35 },
  '112-js-v8-pipeline': { groupId: 'js', level: 'junior', sortInGroup: 36 },
  '113-js-class-engine': { groupId: 'js', level: 'junior', sortInGroup: 37 },
  '114-js-mixins': { groupId: 'js', level: 'senior', sortInGroup: 38 },
  '115-js-web-components': { groupId: 'js', level: 'senior', sortInGroup: 39 },
  '116-js-v8-optimizations': { groupId: 'js', level: 'senior', sortInGroup: 40 },
  '117-js-proto-vs-closure-perf': { groupId: 'js', level: 'senior', sortInGroup: 41 },
  '118-js-webcomponents-css': { groupId: 'js', level: 'senior', sortInGroup: 42 },
  '01-immutability-js': { groupId: 'js', level: 'middle', sortInGroup: 43 },
