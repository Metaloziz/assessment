...
> = {
  ...
  '93-js-lexical-environment': { groupId: 'js', level: 'middle', sortInGroup: 17 },
  ...
  '102-js-factory-functions': { groupId: 'js', level: 'middle', sortInGroup: 26 },
  '103-js-prototypal-inheritance': { groupId: 'js', level: 'middle', sortInGroup: 27 },
  '104-js-null-prototype': { groupId: 'js', level: 'middle', sortInGroup: 28 },
  '105-js-mutation-observer': { groupId: 'js', level: 'middle', sortInGroup: 29 },
  ...
  '120-react-redux-binding': { groupId: 'redux', level: 'junior', sortInGroup: 2 },
  '121-redux-action-dispatch': { groupId: 'redux', level: 'junior', sortInGroup: 3 },
  '122-redux-store-immutability': { groupId: 'redux', level: 'junior', sortInGroup: 4 },
  '123-redux-local-vs-store': { groupId: 'redux', level: 'junior', sortInGroup: 5 },
  '124-redux-saga-thunk': { groupId: 'redux', level: 'middle', sortInGroup: 6 },
  '125-redux-toolkit': { groupId: 'redux', level: 'middle', sortInGroup: 7 },
  '126-redux-feature-first-ducks': { groupId: 'redux', level: 'middle', sortInGroup: 8 },
  '01-immutability-js': { groupId: 'redux', level: 'senior', sortInGroup: 9 },
  '02-normalize-immutable-libs': { groupId: 'redux', level: 'senior', sortInGroup: 10 },
